...
/**
 * Maps a `public.rift_entitlements` row onto the shape the app reads.
 *
 * Kept identical in spirit to `ServerEntitlement` in the mobile app: same
 * columns, same meaning, so "Pro" is one idea across the two clients.
 *
 * @param {Object|null} row - Row from `rift_entitlements`, or null when absent
