/**
 * Free-tier ceilings. RiftTrades Pro removes all of them.
 *
 * These numbers must match the mobile app
 * (`apps/mobile/lib/core/logic/free_limits.dart` after Phase 13 raises binder/want
 * to 50/50). Drift here is not cosmetic: mobile enforces the trade window by
 * deleting the oldest rows, so a higher cap on web would look to the customer
 * like mobile eating trades they had saved.
 *
