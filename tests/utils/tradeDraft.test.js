...
describe('tradeDraft', () => {
    ...
    test('uses the rifttrades localStorage key', () => {
        expect(TRADE_DRAFT_KEY).toBe('rifttrades-trade-draft');
    });
    ...
    test('saveTradeDraft + loadTradeDraft round-trips minimal fields', () => {
        saveTradeDraft(
            ...
            [{ uniqueId: 'b-1', name: 'Beta', subTypeName: 'Foil', quantity: 1, price: 10 }],
        );
